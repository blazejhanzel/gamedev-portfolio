<template>
  <div>
    ...
    <div class="paragraph">
      I'm <strong>John Matrix</strong>, a former Delta Force operative with lots of experience, lots of training and huge
      muscles.
      ...
      <div style="margin-top:20px; margin-bottom:20px;">
        <a class="download-link" href="d/resume-en.pdf" target="_blank"><i class="fa fa-download fa-lg fa-fw"></i>
          Download as PDF 🇬🇧</a>
        <a class="download-link" href="d/cv-fr.pdf" target="_blank"><i class="fa fa-download fa-lg fa-fw"></i> Télécharger
          en PDF 🇫🇷</a>
        <div style="clear:both"></div>
      </div>
    </div>
    <div class="photo">
      <img src="img/avatar.png" alt="Photo of John" />
    </div>
